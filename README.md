...
| Multi-source history recovery | Post-quantum signed manifests, bounded hash-addressed chunks, HTTPS-only remote fetching, agreement from at least two distinct operators, crash-resumable staged installation, and operator commands are implemented locally; independent public deployment remains |
