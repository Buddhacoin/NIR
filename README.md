...
| Local wallet signing bridge | Exact-origin, session-token, terminal-confirmed signing without browser key access or automatic broadcast; implemented locally |
