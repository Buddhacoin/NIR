...
| Multi-source history recovery | Post-quantum signed manifests, bounded hash-addressed chunks, an explicit trusted-operator set, and agreement from at least two distinct operators are implemented locally; independent public archive deployment remains |
