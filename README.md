...
| Independently compiled consensus cross-check | Rust reproduces canonical encoding plus ordinary, sponsored, Transfer Credit and multisignature monetary/resource transitions from shared language-neutral vectors; cryptographic authorization and full-node execution remain outside this profile |
