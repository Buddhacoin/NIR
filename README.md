...
| Pre-activation validator onboarding | Protocol-v7 commitment verifies old quorum, every new consensus/transport key and TLS endpoint; peer registry and finality set activate atomically |
