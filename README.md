...
| Pre-activation validator onboarding | Protocol-v7 verifies old/new identities and endpoints; a restricted union transport carries both quorums, then peer registry and finality set activate atomically |
