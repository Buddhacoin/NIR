...
| Canonical state snapshots with ML-DSA validator quorum | Authenticated multi-peer fast catch-up, dual-quorum handoffs, tail replay, redundant repair, rollback protection, portable backup, and two-stage pruning implemented locally |
